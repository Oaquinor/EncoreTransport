...
assert.equal(calculateTripPrice(targetTrip, 2), 1335);
assert.equal(searchTrips(mockTrips, { origin: 'Santo Domingo', destination: 'Santiago', date: '2026-09-14', passengers: 2 }).length, 1);
